<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"C:\wamp64\www\toy\public/../application/index\view\user\index.html";i:1554522539;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<ul class="layui-nav  layui-layout-right"  style="background: #1c1c1c;">
    ...
    <div class="layui-carousel" id="test1" lay-filter="test1">
        <div carousel-item="" style="background: #0C0C0C; height: 500px">
            <div><img src="<?php echo \think\Config::get('web_root'); ?>images/01.jpg"style="position:center;width: 100%;height: 100%;"/></div>
            <div><img src="<?php echo \think\Config::get('web_root'); ?>images/02.jpg"style="position:center;width: 100%;height: 100%;"/></div>
            <div><img src="<?php echo \think\Config::get('web_root'); ?>images/03.jpg"style="position:center;width: 100%;height: 100%;"/></div>
            <div><img src="<?php echo \think\Config::get('web_root'); ?>images/04.jpg"style="position:center;width: 100%;height: 100%;"/></div>
        </div>
    </div>
    ...
    <div class="layui-container" style=" width:100%; height:670px; ">
        <div class="layui-row layui-col-space1">
            ...
            <div class="layui-col-md3 test-center test" style="height:400px; background-color: white;">
            ...
            <div class="test-center" style="font-size: 28px; font-weight: normal; height: 430px;">
                <div style="background:url('../../../../public/static/images/017.jpg')no-repeat; width:100%; height:100%; background-position:87% -15%;">
                    <p class="test-center" style="font-size: 38px;font-weight: normal; color:whitesmoke; left: 500px; position: absolute; top: 70px;">
                        点击一下，开始使用</p>
                    <a href="demo" class="layui-btn layui-btn-lg layui-btn-primary layui-btn-radius"
