<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"C:\wamp64\www\toy\public/../application/index\view\cms\editnews.html";i:1554897896;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8" />
                            ...
                            <div class="widget-body">
                                <form action="edit" class="form-horizontal" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="tittle" name="tittle" value="<?php echo $news['tittle']; ?>" placeholder="新闻标题" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="author" class="control-label col-sm-2">作者</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="author" name="author" value="<?php echo $news['author']; ?>" placeholder="作者名字" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="content" class="control-label col-sm-2">新闻概要</label>
                                        <div class="col-sm-6">
                                            <textarea name="desc" id="desc" cols="30" rows="5" class=""><?php echo $news['desc']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="tag" class="col-sm-2 control-label no-padding-right">新闻标签</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="tag" name="tag" value="<?php echo $news['tag']; ?>" placeholder="标签">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea name="content" id="content" cols="30" rows="10" class=""><?php echo $news['content']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
