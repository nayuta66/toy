<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\wamp64\www\toy\public/../application/index\view\demo\shishijiankong.html";i:1554018204;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<ul class="layui-nav layui-nav-tree layui-bg-blue layui-inline" lay-filter="chuizhi">
  <li class="layui-nav-item layui-nav-itemed">
    ...
    <dl class="layui-nav-child">
      <dd><a href="#one">销量监控</a></dd>
      <dd><a href="#two">库存监控</a></dd>
    </dl>
  </li>
  <li class="layui-nav-item layui-nav-itemed">
  ...
  <div class="layui-row layui-col-space15">
    <div class="layui-col-xs12">
      <div class="layui-card">
		...
		<a name="one"></a>
        <div style="font-size:16px"><b>销量监控</b></div>
        </div>

        <div class="layui-card-body">

          <div id="xiaojiankong" style="width:700px; height:400px; margin:auto;"></div>
          <script src="<?php echo \think\Config::get('web_root'); ?>javascript/echarts/echarts-all.js"></script>
          <script src="<?php echo \think\Config::get('web_root'); ?>javascript/shishijiankong/xiaojian.js"></script>
        ...
        <div class="layui-row layui-col-space15">
          ...
          <div class="layui-col-xs12">
            <div class="layui-card">
              ...
              <div class="layui-card-header">
                <a name="two"></a>
                <div style="font-size:16px"><b>库存监控</b></div>
              </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                      ...
                      <div class="layui-input-inline">
                        <select id="toysorts" name="modules" lay-verify="required" lay-search="">
                          <option value="">请选择</option>
                          <option value="1" selected="">毛熊</option>
                          <option value="2">超人模型</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="layui-inline">
                      ...
                      <div class="layui-input-inline">
                        <select id="cplaces" name="modules" lay-verify="required" lay-search="">
                          <option value="">请选择</option>
                    ...
                    <div class="layui-input-inline">
                      <button id="btnx" class="layui-btn layui-bg-blue" lay-submit="" lay-filter="lifeshangpin">确定</button>
                    </div>

                  </div>
                </div>

              <div id="kujiankong" style="width: 700px; height:400px; margin:auto;"></div>
                <script src="<?php echo \think\Config::get('web_root'); ?>javascript/highcharts/highcharts.js"></script>
                <script src="<?php echo \think\Config::get('web_root'); ?>javascript/shishijiankong/kujian.js"></script>

<script>
    window.onload=function () {
        var btnx=document.getElementById("btnx");
        btnx.onclick=function () {
            var toysorts=document.getElementById("toysorts").value;
			var cplaces=document.getElementById("cplaces").value;
            if ((toysorts=="1")&&(cplaces=="1")){
                var kujiankong=document.getElementById("kujiankong");
                var scx = document.createElement("SCRIPT");
                scx.src="<?php echo \think\Config::get('web_root'); ?>javascript/shishijiankong/kujian.js";
                kujiankong.appendChild(scx);
            }
			if ((toysorts=="1")&&(cplaces=="2")){
                var kujiankong=document.getElementById("kujiankong");
                var scx = document.createElement("SCRIPT");
                scx.src="<?php echo \think\Config::get('web_root'); ?>javascript/shishijiankong/kujian2.js";
                kujiankong.appendChild(scx);
            }
			if ((toysorts=="2")&&(cplaces=="1")){
                var kujiankong=document.getElementById("kujiankong");
                var scx = document.createElement("SCRIPT");
                scx.src="<?php echo \think\Config::get('web_root'); ?>javascript/shishijiankong/kujian3.js";
                kujiankong.appendChild(scx);
            }
			if ((toysorts=="2")&&(cplaces=="2")){
                var kujiankong=document.getElementById("kujiankong");
                var scx = document.createElement("SCRIPT");
                scx.src="<?php echo \think\Config::get('web_root'); ?>javascript/shishijiankong/kujian4.js";
                kujiankong.appendChild(scx);
            }
        }
	}
