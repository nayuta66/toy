<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"C:\wamp64\www\toy\public/../application/index\view\cms\index.html";i:1554893858;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" type="text/css" href="<?php echo \think\Config::get('web_root'); ?>static/h-ui.admin/skin/green/skin.css" id="skin" />
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">大数据玩具平台</a>
				...
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:;" onclick="article_add('添加资讯','addnews.html')"><i class="Hui-iconfont">&#xe616;</i> 资讯</a></li>
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li id="Hui-skin" class="dropDown right dropDown_hover"> <a href="javascript:;" class="dropDown_A" title="换肤"><i class="Hui-iconfont" style="font-size:18px">&#xe62a;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
                        <li><a href="javascript:;" data-val="default" title="黄色">默认</a></li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
        ...
        <dl id="menu-tongji">
			...
			<dd>
				<ul>
                <li><a data-href="data.html" data-title="数据列表" href="javascript:void(0)">数据列表</a></li>
				</ul>
			</dd>
		</dl>
        <dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="listnews.html" data-title="文章列表" href="javascript:void(0)">文章列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="feedback_list.html" data-title="留言板" href="javascript:;">留言板</a></li>
				</ul>
			</dd>
		</dl>
	</div>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="<?php echo \think\Config::get('web_root'); ?>lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
