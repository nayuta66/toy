<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"C:\wamp64\www\toy\public/../application/index\view\demo\gequdao.html";i:1551964709;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-col-xs12">
                    <div class="layui-card">
                        <div class="layui-card-header">
                            <a name="one"></a>
                            <div style="font-size:16px"><b>各平台销售数量</b></div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="layui-tab">
                                ...
                                <div class="layui-tab-content">
                                    <div class="layui-tab-item">
                                        <div id="jinyitian" style="width:500px;height:300px;margin: auto"></div>
                                        <script src="<?php echo \think\Config::get('web_root'); ?>javascript/gequdao/jinyitian.js"></script>
                                    </div>
                                    <div class="layui-tab-item layui-show">
                                        <div id="jinyizhou" style="width:500px;height:300px;margin: auto"></div>
                                        <script src="<?php echo \think\Config::get('web_root'); ?>javascript/gequdao/jinyizhou.js"></script>
                                    </div>
                                    <div class="layui-tab-item">
                                        <div id="jinyigeyue" style="width:500px;height:300px;margin: auto"></div>
                                        <script src="<?php echo \think\Config::get('web_root'); ?>javascript/gequdao/jinyigeyue.js"></script>
                                    </div>
                                    <div class="layui-tab-item">
                                        <div id="jinyinian" style="width:500px;height:300px;margin: auto"></div>
                                        <script src="<?php echo \think\Config::get('web_root'); ?>javascript/gequdao/jinyinian.js"></script>
                                    </div>
                        ...
                        <div class="layui-card-body">
                            <div class="layui-form">
                                ...
                                <table class="layui-table">
                                    <thead>
                                    <tr>
                                        <th>平台</th> <th>App</th> <th>微信</th> <th>实体店A</th> <th>实体店B</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        <td>近一日</td> <td>2000</td> <td>3000</td> <td>4000</td> <td>4000</td>
                                    </tr>
                                    <tr>
                                        <td>近一周</td> <td>4620</td> <td>5910</td> <td>9100</td> <td>9100</td>
                                    </tr>
                                    <tr>
                                        <td>近一个月</td> <td>18490</td> <td>23700</td> <td>37000</td> <td>37000</td>
                                    </tr>
                                    <tr>
                                        <td>近一年</td> <td>211880</td> <td>284490</td> <td>457000</td> <td>457000</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
